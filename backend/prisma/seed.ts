...
async function main() {
  ...
  for (const tier of gamificationLevels) {
    await prisma.levelTable.upsert({
      where: { level: tier.level },
      update: tier,
      create: tier,
    });
  }
  console.log(`  ✅ ${gamificationLevels.length} gamification levels created`);
  ...
  const words = [
    { word: 'cobblestone', definition: 'A small, rounded stone used to cover roads', exampleSentence: 'She walked along the cobblestone streets.', phonetic: '/ˈkɒb.əl.stəʊn/', level: Level.A2 },
    { word: 'boulangerie', definition: 'A French bakery', exampleSentence: 'The smell of bread came from the nearby boulangerie.', phonetic: '/buˌlɑ̃ʒ.ʁi/', level: Level.A2 },
    { word: 'routine', definition: 'A regular way of doing things', exampleSentence: 'Maria liked her daily routine.', phonetic: '/ruːˈtiːn/', level: Level.A1 },
    { word: 'algorithm', definition: 'A set of rules for solving a problem', exampleSentence: 'Machine learning algorithms are increasingly sophisticated.', phonetic: '/ˈæl.ɡə.rɪ.ðəm/', level: Level.B1 },
    { word: 'unprecedented', definition: 'Never done or known before', exampleSentence: 'AI presents unprecedented opportunities.', phonetic: '/ʌnˈpres.ɪ.den.tɪd/', level: Level.B2 },
    { word: 'moist', definition: 'Slightly wet', exampleSentence: 'The soil should be moist, not wet.', phonetic: '/mɔɪst/', level: Level.A1 },
    { word: 'manuscript', definition: 'A handwritten or typed text', exampleSentence: 'The composer sat before the blank manuscript.', phonetic: '/ˈmæn.jʊ.skrɪpt/', level: Level.B2 },
    { word: 'elusive', definition: 'Difficult to find or achieve', exampleSentence: 'Inspiration remained elusive.', phonetic: '/ɪˈluː.sɪv/', level: Level.B2 },
  ];
